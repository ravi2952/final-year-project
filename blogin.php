...
?>
<form name="f" action="blogin.php" method="post">
    <table class="login">
        <thead>
            <tr>
                <th colspan="2">BANK LOGIN</th>
            </tr>
        </thead>
        <tbody>
            <tr>
        ...
        <tfoot>
            <tr>
                <td colspan="2" class="center">
                    ...
                    <br>
                    New Bank ? <a href="bregn.php">Register Here</a>
                </td>
            </tr>
        </tfoot>
    </table>
...
<?php
    ...
    extract($_POST);
        $result = mysqli_query($link, "select * from bank where userid='$userid' and 
pwd='$pwd' and accept='accept'") or die(mysqli_error($link));
        if(mysqli_num_rows($result)>0) {
            $_SESSION['bankid'] = $userid;
            header("Location:bankhome.php");
        } else {
            echo "<div class='center'>Check Userid/Password...!<br>(Or)<br>Administrator Acceptance is in Pending...!<br><a href='blogin.php'>Back</a></div>";
        }
