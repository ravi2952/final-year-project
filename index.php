        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-4 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="">
                        <img class="w-50 h-100 rounded" src="img/insur.jpg" style="width:100px;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
                        <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">About</h5>
                        <h1 class="display-4">Loan Platform</h1>
                    </div>
                    <p>Loan process is done in a secure manner.  The Admin, User and the Bank can work on the application platform securely.</p>
