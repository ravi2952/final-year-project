            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="regn.php" class="nav-item nav-link">Regn</a>
                    </div>
                </div>
            </nav>
        </div>
        ...
        <div class="container py-2">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <h1 class="display-2 text-primary mb-md-4">BlockChain Crowd Sourcing Loan Platform</h1>
                    <div class="pt-2">
            ...
            <div class="row gx-5">                
                <div class="col-lg-12">
                    ...
                    <p style="text-align: center;">
                        <a href="alogin.php" class="link_button">ADMIN</a> | 
                        <a href="dlogin.php" class="link_button">BANK</a> |                        
                        <a href="ulogin.php" class="link_button">STUDENT</a>
                    </p>                    
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-md-0">&copy; <a class="text-primary" href="#">Loan Platform</a>. All Rights Reserved.</p>
                </div>
