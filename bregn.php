...
?>
<br>
<form name="f" action="bregn.php" method="post" onsubmit="return check_regn()">
    <table class="login" style="width:50%;">
        <thead>
            <tr>
                <th colspan="2">BANK REGISTRATION</th>
            </tr>
        </thead>
        <tbody>
            <tr>
...
<?php
    ...
    extract($_POST);    
    $b = mysqli_query($link, "insert into bank(bname,addr,cname,aname,mobile,userid,pwd) values('$bname','$addr','$cname','$aname','$mobile','$email','$pwd')") or die(mysqli_error($link));
    if($b)
    echo "<div class='center'>Login Id Generated Successfully...!<br><a href='blogin.php'>Login</a></div>";
    else
    echo "<div class='center'>".mysqli_error($link)."...!<br><a href='bregn.php'>Back</a></div>";
}
include './footer.php';
?>
<script>
